...
public class RecurringDAO extends AbstractDAO<Recurring> {
    ...
    public void update(Recurring recurring) {
        persist(recurring);
		//ASTClass.instrum("Expression Statement","recurring,",persist(recurring)","77");
		//ASTClass.instrum("Expression Statement","recurring,",persist(recurring)","79");
		//ASTClass.instrum("Expression Statement","recurring,",persist(recurring)","81");
		//ASTClass.instrum("Expression Statement","recurring,",persist(recurring)","83");
    }
}
