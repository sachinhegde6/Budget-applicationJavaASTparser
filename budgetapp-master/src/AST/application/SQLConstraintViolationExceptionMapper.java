    ...
    private List<String> getMessage(PersistenceException e) {
        ...
        if(e.getCause() instanceof ConstraintViolationException) {
            ...
            if ("fk_budgets_categories".equalsIgnoreCase(cve.getConstraintName())) {
				...
				if ("fk_transactions_budgets".equalsIgnoreCase(cve.getConstraintName())) {
                return Collections.singletonList("Failed to delete budget due to references to existing transaction(s).");
				}
				//ASTClass.instrum("If Statement","37");
				//ASTClass.instrum("If Statement","39");
				//ASTClass.instrum("If Statement","41");
				//ASTClass.instrum("If Statement","43");
			}
			//ASTClass.instrum("If Statement","40");
			//ASTClass.instrum("If Statement","38");
			//ASTClass.instrum("If Statement","36");
			//ASTClass.instrum("If Statement","34");
		...
		//ASTClass.instrum("If Statement","33");
		//ASTClass.instrum("If Statement","34");
    }
}
