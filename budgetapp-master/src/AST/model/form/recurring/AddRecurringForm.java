...
public class AddRecurringForm implements Serializable {
    ...
    public void setRemark(String remark) {
		...
		//ASTClass.instrum("Expression Statement","remark,",this.remark=remark","69");
		//ASTClass.instrum("Expression Statement","remark,",this.remark=remark","73");
		//ASTClass.instrum("Expression Statement","remark,",this.remark=remark","77");
    }
}
